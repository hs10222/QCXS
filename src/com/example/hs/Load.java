...
public class Load extends BaseActivity {
	...
	private void InitUserNameLayout() {
		...
		tv_user.setTextSize(TypedValue.COMPLEX_UNIT_PX, screenWidth * 35 / 720);
	...
	private void InitUserPassWordLayout(){
		// 密码布局
				...
				tv_pass.setTextSize(TypedValue.COMPLEX_UNIT_PX, screenWidth * 35 / 720);
	...
	private void InitLoadLayout(){
		...
		btn_load.setTextSize(TypedValue.COMPLEX_UNIT_PX, screenWidth * 40 / 720);
		btn_load.setGravity(Gravity.CENTER);
		btn_load.setBackgroundResource(R.drawable.load);
		LinearLayout.LayoutParams llp_load = new LinearLayout.LayoutParams(screenWidth * 400 / 720, screenWidth * 120 / 720);
		llp_load.setMargins(screenWidth * 50 / 720, screenWidth * 50 / 720, 0, 0);
